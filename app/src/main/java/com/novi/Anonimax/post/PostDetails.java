package com.novi.Anonimax.post;
...
public class PostDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView name,type,text,text1,likeNo,commentNo,views;
    EditText textBox;
    ConstraintLayout constraintLayout9,viewlt;
    private String userId, myName, myDp;
    private DatabaseReference mDatabase;
    String hisId, hisName, postId, pLikes, hisDp, hisMeme, hisVine, hisTime, hisText, hisText1, hisTypes;
    ...
    private void showMoreOptions() {
        ...
        popupMenu.getMenu().add(Menu.NONE,2,0, "Sviđa se");
        if(!meme.equals("noImage") || !vine.equals("noVideo")){
            popupMenu.getMenu().add(Menu.NONE,3,0, "Cijeli ekran");
        }
        ...
        likeRef.child(postId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (numOfLikes.equals("0")) {
                    likeNo.setText("Pozitivno");

                } else {
                   likeNo.setText(snapshot.getChildrenCount()+" smarta istinito");
                }
    ...
    private void setLikes() {
        ...
        likeRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                like_img.setImageResource(R.drawable.plus);

                }else {
             like_img.setImageResource(R.drawable.krug);
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    hisText1 = ""+ds.child("text1").getValue();
                    ...
                    String ed_text1 = text1.getText().toString().trim();      //promijeniti ili će brisati ako jedan od textova fali. 625-634
                    if(ed_text.length() > 0)
                    {
                        constraintLayout9.setVisibility(View.VISIBLE);
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.novi.poslodavac.fileprovider", file);
