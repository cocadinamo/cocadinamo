...
public class Post extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text1 = findViewById(R.id.post_text1);
...
post_vine.setVisibility(View.GONE);
        ...
        post_vine.setOnClickListener(v -> {
            ...
            String mText1 = text1.getText().toString().trim();

            if (TextUtils.isEmpty(mText) || TextUtils.isEmpty(mText1) ) {
                Alerter.create(Post.this)
                        ...
                        .setText("Upiši sve podatke")
                        .show();
            } else{
                uploadVine(mText, mText1, String.valueOf(video_uri));
            }
        ...
        post.setOnClickListener(v -> {
            ...
            if (image_uri == null){
                pd.setVisibility(View.VISIBLE);
                uploadData(mText, mText1, "noImage");
            }
            else {
                uploadData(mText, mText1,String.valueOf(image_uri));
                pd.setVisibility(View.VISIBLE);
            }
    ...
    private void sendText(Intent intent) {
        ...
        if (sharedText!=null){
            ...
            text1.setText(sharedText);
        }
    }

    private void uploadData(String mText, String mText1, String uri) {
                            ...
                            dRef.child(timeStamp).setValue(hashMap)
                                    .addOnSuccessListener(aVoid -> {
                                        ...
                                        Alerter.create(Post.this)
                                                ...
                                                .setTitleTypeface(Typeface.createFromAsset(getAssets(), "bold.ttf"))
                                                .setTextTypeface(Typeface.createFromAsset(getAssets(), "med.ttf"))
                                                .setText("Objava uspješno objavljena")
                                                .show();
                                    })
    ...
    private void uploadVine(String mText, String mText1, String uri) {
        String timeStamp = String.valueOf(System.currentTimeMillis());
        String filePathAndName = "Post/" + "Post_" + timeStamp;
        StorageReference ref = FirebaseStorage.getInstance().getReference().child(filePathAndName);
