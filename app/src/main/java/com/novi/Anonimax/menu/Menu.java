package com.novi.Anonimax.menu;
...
import com.novi.Anonimax.user.MyFollowing;
import com.novi.Anonimax.welcome.IntroLast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       sharedPref = new SharedPref(this);
        ...
        invite.setOnClickListener(v -> {
            String shareBody = "Poslodavac - aplikacija o poslodavcima" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.novi.poslodavac";
        ...
        delete.setOnClickListener(v -> {
            ...
            builder.setMessage("Da li želite obrisati račun ?");
            builder.setPositiveButton("Obriši", (dialog, which) -> firebaseUser.delete().addOnSuccessListener(aVoid -> {
